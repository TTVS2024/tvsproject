...
class _WorksheetFormState extends State<WorksheetForm> {
  ...
  TextEditingController topicgivenasselflearningController =
      TextEditingController();
  TextEditingController resourcessharedController = TextEditingController();
  TextEditingController detailsofresourcesController = TextEditingController();
  TextEditingController followupactitvitiesController = TextEditingController();
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 10),
              TextFormField(
                controller: topicgivenasselflearningController,
                decoration: InputDecoration(
                  labelText: '% Of topic given as self learning',
                  border: OutlineInputBorder(),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              SizedBox(height: 10),
              TextFormField(
                controller: resourcessharedController,
                decoration: InputDecoration(
                  labelText: 'Resources Shared',
                  border: OutlineInputBorder(),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              SizedBox(height: 10),
              TextFormField(
                controller: detailsofresourcesController,
                decoration: InputDecoration(
                  labelText: 'Details Of Resources',
                  border: OutlineInputBorder(),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              SizedBox(height: 10),
              TextFormField(
                controller: followupactitvitiesController,
                decoration: InputDecoration(
                  labelText: 'Follow Up Activities',
                  border: OutlineInputBorder(),
                ),
                validator: (value) {
                  if (value == null || value.isEmpty) {
