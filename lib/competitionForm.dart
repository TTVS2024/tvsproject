...
class competition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('NA13-Competition Details'),
...
class _WorksheetFormState extends State<WorksheetForm> {
  ...
  TextEditingController groupeventController = TextEditingController();
  TextEditingController nameController = TextEditingController();
  TextEditingController eventnameController = TextEditingController();
  TextEditingController organizedbyController = TextEditingController();
  TextEditingController venueController = TextEditingController();
  TextEditingController escortedbyController = TextEditingController();
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              const SizedBox(height: 10),
              TextFormField(
                controller: escortedbyController,
                decoration: InputDecoration(
                  labelText: 'Escorted By',
                  border: OutlineInputBorder(),
                ),
